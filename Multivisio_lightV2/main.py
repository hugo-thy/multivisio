...
def main():
    ...
    keypoints = [int(k * videoScale) for k in [0, 0, 0, 0, 0, 0, 0, 0]] #A completer

    #vidéos de test and keypoints
    ...
    # loop pour une vidéo
    multivisio.loop(input_stream_path, keypoints, fpsDivider=5, videoScale=videoScale)
    # multi-caméra
